...
```
$ git clone --recursive git@github.com:51616/human_aware_rl.git
```

If you want to clone a specific branch with its submodules, use:
```
$ git clone --single-branch --branch BRANCH_NAME --recursive git@github.com:51616/human_aware_rl.git
```
